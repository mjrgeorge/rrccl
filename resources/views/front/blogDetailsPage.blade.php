        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="vs-blog blog-single">
                    <div class="blog-img"><img src="{{url('image/blog',$details->blog->image)}}" alt="Blog Image"></div>
                    <div class="blog-content">
                        <div class="blog-meta"><a href="#"><i class="fal fa-eye"></i>232 Views</a> <a href="#"><i
                                    class="fal fa-comments"></i>Comments</a> <a href="#"><i class="fal fa-eye"></i><?php $date = \Carbon\Carbon::parse($details->blog->date); ?>
                                        {{$date->format('d F, Y')}}</a></div>
                        <h2 class="blog-title h3">{{$details->blog->title}}</h2>
                        <p>{{$details->first_details}}</p>
                        <blockquote>
                            <p>{{$details->quotation}}</p>
                        </blockquote>
                        <p>{{$details->second_details}}</p><img
                            src="{{url('image/blog/details',$details->image)}}" alt="Blog Image" class="my-30">
                        <h2>{{$details->title}}</h2>
                                ...
                                <div class="thumb-post">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <a class="post-date" href="#">
                                            <i class="fal fa-calendar-alt"></i><?php $date = \Carbon\Carbon::parse($v->blog->date); ?>
                                            {{$date->format('F d , Y')}}
                                        </a>
                                    </div>
                                </div> 
