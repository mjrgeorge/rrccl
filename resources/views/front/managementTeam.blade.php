...
<div class="breadcumb-wrapper">
    ...
    <div class="container z-index-common">
        <div class="breadcumb-content">
            <h1 class="breadcumb-title">Management Team</h1>
            <div class="breadcumb-menu-wrap">
                ...
                <ul class="breadcumb-menu">
                    ...
                    <li class="active">Our Managment Team</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="team-card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-xl-8">
                            <h3 class="h4 mb-0">
                                <a href="{{route('teamDetails',$v->id)}}" class="text-reset">Message of {{$v->team->expertise}}</a>
                            </h3>
                            <!--<p class="fs-xs degi text-theme mb-2">Message of {{$v->team->expertise}}</p>-->
                            <p class="fs-xs">{{$v->team->details}}</p>
                            <div class="">
                                 <p class="fs-xs team-info">
                                     <i class="fas fa-name text-theme"></i>
                                    <a class="text-reset">{{$v->team->name}}</a>
                                </p>
                                 <p class="fs-xs team-info">
                                     <i class="fas fa-name text-theme"></i>
                                    <a class="text-reset">{{$v->team->expertise}}</a>
                                </p>
                                <p class="fs-xs team-info">
                                    <i class="fas fa-phone text-theme"></i>
                                    <a class="text-reset" href="tel:{{$v->team->phone}}">{{$v->team->phone}}</a>
