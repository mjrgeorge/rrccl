...
<section class="vs-blog-wrapper space-top space-md-bottom">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                @foreach ($blogDetails as $v)
                <div class="vs-blog blog-single">
                    <div class="blog-img">
                        <a href="{{route('blog_deails',$v->id)}}">
                            <img src="@if(!empty($v->blog->image)) {{url('image/blog',$v->blog->image)}}  @endif" alt="Blog Image"></a>
                    </div>
                    <div class="blog-content">
                        <div class="blog-meta">
                            <a href="#">
                                <i class="fal fa-eye"></i><?php $date = \Carbon\Carbon::parse($v->blog->date); ?>
                                {{$date->format('d F, Y')}}
                            </a>
                        </div>
