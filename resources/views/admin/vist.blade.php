        ...
        <section class="content-header">
            ...
            <div class="header-title">
                ...
                <ol class="breadcrumb hidden-xs">
                    ...
                    <li class="active">Add Visting Hours</li>
                </ol>
            </div>
        </section>
        <!-- Main content -->
                    ...
                    <div class="panel panel-bd lobidisable">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <a class="btn btn-primary" href="#"> <i class="fa fa-list"></i>Add Visting Hours </a>
                            </div>
                        </div>
                        <div class="panel-body">
                            ...
                            @endif
                            <form class="col-sm-12" action="{{route('addHours')}}" method="POST"
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>{{$v->time}}</td>
                                        <td>
                                            <form action="{{route('deleteHours',$v->id)}}" method="POST">
                                                @csrf
                                                @method('delete')
                                                <br>
