                    ...
                    <div class="panel panel-bd lobidisable">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <div class="btn-group">
                                    <a class="btn btn-primary" href="{{route('news.index')}}"> <i class="fa fa-list"></i> News List </a>
                                </div>
                            </div>
                        </div>
                        <div class="panel-body">
                            ...
                            @endif
                            <form class="col-sm-12" action="{{route('newsDetailsAdd')}}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="col-sm-12 form-group">
                                    <label>News Title</label>
                                    <input type="hidden" value="{{$news->id}}" name="news_id">
                                    <input type="text" class="form-control" name="title_not_used" placeholder="Enter the service Title" value="{{$news->title}}" disabled><br>
                                ...
                                <div class="col-sm-12 form-group">
                                    <label>Title</label>
                                    <input type="text" class="form-control" name="title" placeholder="Doctor Name" @if (!empty($details)) value="{{$details->title}}" @endif 
                                    >
                                </div>
                                <div class="col-sm-12 form-group">
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    @if (!empty($details))
                                       <img src="{{url('image/news/details',$details->image)}}" alt="" height="150" width="250">
                                    @endif 
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    @if (!empty($details))  
                                      <img src="{{url('image/blog/details',$details->short_image_two)}}" alt="" height="150" width="250">
