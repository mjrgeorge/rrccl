                    ...
                    <div class="panel panel-bd lobidisable">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <a class="btn btn-primary" href="{{route('blogs.create')}}"> <i
                                    class="fa fa-list"></i> Blog Form </a>
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered table-hover" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{url('image/blog',$v->image)}}" alt="User Image"
                                                    height="150" width="250"></td>
                                            <td>
                                                <a href="{{route('blogs.show',$v->id)}}" class="btn btn-info btn-xl"><i
                                                        class="fa fa-plus"></i></a><br><br>
                                                <a href="{{route('blogs.edit',$v->id)}}" class="btn btn-info btn-xl"><i
