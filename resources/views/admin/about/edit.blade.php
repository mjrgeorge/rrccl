                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="panel panel-bd lobidisable">
                        ...
                        <div class="panel-body">
                            ...
                            @endif
                            <form class="col-sm-12" action="{{route('updateEdit',$aboutModel->id)}}" method="POST"
                                ...
                                <div class="col-sm-4 form-group">
                                    ...
                                    <input type="text" class="form-control" name="title"
                                        placeholder="Enter the service Title" value="{{$aboutModel->title}}"><br>

                                </div>
                                <div class="col-sm-4 form-group">
                                    <label>Nmber of Experience</label>
                                    <input type="text" class="form-control" name="number"
                                        placeholder="Nmber of Experience" value="{{$aboutModel->number}}"><br>

                                </div>
                                <div class="col-sm-4 form-group">
                                    <label>Icon</label>
                                    <input type="text" class="form-control" name="icon" value="{{$aboutModel->icon}}"
                                        placeholder="Put Your Icon for you service">
                                </div>
                                <div class="col-sm-12 form-group">
                                    <label>Details</label>
                                    <textarea name="details" id="" class="form-control" cols="10" rows="5"
                                        placeholder="Enter Short Details of your service">{{$aboutModel->details}}</textarea>
                                </div>
