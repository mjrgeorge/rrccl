                    ...
                    <div class="panel panel-bd lobidisable">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <div class="btn-group">
                                    <a class="btn btn-primary" href="{{route('slider.index')}}"> <i
                                            class="fa fa-list"></i> Slider List </a>
                                </div>
                            </div>
                        </div>
                        <div class="panel-body">
                            ...
                            @endif
                            <form class="col-sm-12" action="{{route('slider.update',$slider->id)}}" method="POST"
                                ...
                                <div class="col-sm-12 form-group">
                                    ...
                                    <img src="{{url('image/slider/',$slider->image)}}" alt="" height="150" width="350">
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label>Slider Text First</label>
                                    <input type="text" class="form-control" name="slider_text_one"
                                        value="{{$slider->slider_text_one}}"
